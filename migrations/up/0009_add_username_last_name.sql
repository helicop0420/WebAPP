...
ALTER TABLE public.user_profiles RENAME COLUMN name TO first_name;
...
COMMENT ON COLUMN public.user_profiles.handle
    IS 'username for the user, unique per user';
...
REVOKE ALL ON TABLE public.profile_page_view FROM authenticated;
REVOKE ALL ON TABLE public.profile_page_view FROM supabase_admin;
REVOKE ALL ON TABLE public.profile_page_view FROM postgres;
REVOKE ALL ON TABLE public.profile_page_view FROM anon;
REVOKE ALL ON TABLE public.profile_page_view FROM service_role;
GRANT ALL ON TABLE public.profile_page_view TO anon;
